...
open class SwipeMenuViewController: UIViewController, SwipeMenuViewDelegate, SwipeMenuViewDataSource {
    ...
    open func swipeMenuView(_ swipeMenuView: SwipeMenuView, showDotForTabAt index: Int) -> Bool? {
        return nil
    }
    ...
    open func swipeMenuView(_ swipeMenuView: SwipeMenuView, imageForPageAt index: Int) -> UIImage? {
        return nil
    }
}
