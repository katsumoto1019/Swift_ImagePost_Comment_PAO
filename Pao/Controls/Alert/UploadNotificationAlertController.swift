//
//  UploadNotificationAlertController.swift
//  Pao
//
//  Created by OmShanti on 02/10/20.
//  Copyright © 2020 Exelia. All rights reserved.
//

import UIKit

class UploadNotificationAlertController: UIViewController {
    ...
    private func setupContainerViews() {
        containerView.makeCornerRound(cornerRadius: 20)
    ...
    private func setupSubViews() {
        if let label = addLabel(forText: textString) {
            label.font = UIFont.appMedium.withSize(UIFont.sizes.medium)
        }
    }
