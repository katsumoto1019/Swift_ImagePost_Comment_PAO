...
open class UPCarouselFlowLayout: UICollectionViewFlowLayout {
    ...
    fileprivate func updateLayout() {
        ...
        // this used to be as per comment below
        // but changed by [EG] to align carousel items at the top and not center
        //let yInset = (collectionSize.height - self.itemSize.height) / 2
        // also note below, top was yInset too, now 0
        let yInset = collectionSize.height - self.itemSize.height
        let xInset = (collectionSize.width - self.itemSize.width) / 2
        self.sectionInset = UIEdgeInsets.init(top: 0, left: xInset, bottom: yInset, right: xInset)
